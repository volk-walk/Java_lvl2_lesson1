public class Main {
    ...
    static void arr1() {
        ...
        System.out.println("Время расчета формулы в одном потоке: " + (System.currentTimeMillis() - a)+ " ms");
    }
    ...
    static void arr2() {
        ...
        System.currentTimeMillis();
        System.out.println("время расчета формулы в двух потоках: " + (System.currentTimeMillis() - a) + " ms");
    }
}
